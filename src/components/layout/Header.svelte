	...
	<nav class="flex">
		<a class="m-3 flex items-center" href="/">
			<img
				...
				class="h-[30px] w-[30px] transition-transform duration-200 hover:scale-110"
			/>
		</a>
		<a class="m-3 ml-auto flex items-center" href="https://github.com/Derek4aty1/lol-champion-explorer" target="_blank">
			<img
